    ...
    IHttpClientFactory httpClientFactory)
{
    ...
    /// <summary>
    /// Fetches cost data for all configured providers that have an API key
    /// and aggregates the results into a total report.
    /// </summary>
        ...
        CancellationToken ct = default)
    {
        ...
        var providers = await db.Providers.ToListAsync(ct);
