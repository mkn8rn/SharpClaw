...
/// <summary>
/// Grants a role access to a specific website via the .NET HTTP service
/// (not through a terminal browser).
/// </summary>
public class WebsiteAccessDB : BaseEntity
{
    /// <summary>
    ...
    public WebsiteDB Website { get; set; } = null!;
}
