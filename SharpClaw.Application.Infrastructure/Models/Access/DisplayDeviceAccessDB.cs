...
/// <summary>
/// Grants a role access to a specific display device for desktop
/// screen capture.
/// </summary>
public class DisplayDeviceAccessDB : BaseEntity
{
    /// <summary>
    ...
    public DisplayDeviceDB DisplayDevice { get; set; } = null!;
}
